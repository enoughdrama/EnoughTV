...
import AnimeTeamMembers from './AnimeTeamMembers';
import AnimeTorrents from './AnimeTorrents';
import './styles/animeDetails.css';

const AnimeDetails = ({ animeId, onWatchEpisode, onAnimeClick, setSelectedAnimeName }) => {
  ...
  const [shikimoriEpisodes, setShikimoriEpisodes] = useState({});
    ...
    const fetchAnimeDetails = async () => {
      ...
      try {
        ...
        if (data) {
          ...
          if (setSelectedAnimeName && data.name && data.name.main) {
            setSelectedAnimeName(data.name.main);
          }
  ...
  const getScoreColor = (score) => {
    const colors = [
      '#c13a3a', '#d84939', '#e35a37', '#e97234', '#ed8934',
      '#e0a135', '#c2b135', '#98b344', '#75b366', '#4c8dc3'
    ];
        ...
        <div className="anime-details-header-content">
          ...
          <div className="anime-details-info">
            ...
            >
              ...
              {anime.publish_day && anime.publish_day.description && (
                <span className="anime-badge release-day">
                  <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" width="14" height="14" style={{ marginRight: '4px' }}>
      ...
      <div className="content-container">
        ...
        >
          <div className="tabs">
            ...
            <motion.button
              className={`tab ${activeTab === 'torrents' ? 'active' : ''}`}
        ...
        <AnimatePresence mode="wait">
          {activeTab === 'info' ? (
              ...
              <div className="anime-info">
                ...
                <div className="info-section">
                  ...
                  <ul className="detail-list">
                    ...
                    {anime.publish_day && anime.publish_day.description && (
                      <li>
                        <span className="detail-label">День выхода:</span>
                        <span className="detail-value">{anime.publish_day.description}</span>
                      </li>
                    )}
                    {anime.notification && (
                      <li>
                        <span className="detail-label">Расписание:</span>
                        <span className="detail-value">{anime.notification}</span>
                      </li>
                    )}
                    <li>
                    ...
                    {shikimoriId && (
                      <li>
                        <span className="detail-label">Shikimori:</span>
            ...
            <motion.div
              ...
              transition={{ duration: 0.3 }}
            >
              <AnimeTeamMembers animeId={animeId} />
            </motion.div>
          ) : activeTab === 'torrents' ? (
            <motion.div
              className="tab-content"
